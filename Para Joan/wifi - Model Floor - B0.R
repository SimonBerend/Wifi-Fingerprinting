# -------------------------------------------------------------------------
# GOAL: Model to predict FLOOR in Building 0
# DEVELOPER: BEREND
...
# Here, I use the validation set to test the model
...
# remove suspect waps 71, 72, 49, 50 (13 is not ok either, but removing weakens model)
...
# Note : Most of my models are knn, check Floor model for B1 to see difference
start_time <- Sys.time()
